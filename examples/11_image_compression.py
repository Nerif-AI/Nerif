...
def example_advanced_compression():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        was_compressed, ratio, message = compressor.compress_image(original_jpg, compressed_jpg)
...
def example_batch_compression():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i in range(3):
            img = Image.new("RGB", (1600, 1200), color=(50 + i * 50, 100 + i * 30, 150 + i * 20))
...
def example_custom_compression_settings():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        test_configs = [
            {"name": "High Quality", "jpeg_quality": 95, "png_compress_level": 6},
            {"name": "Balanced", "jpeg_quality": 85, "png_compress_level": 9},

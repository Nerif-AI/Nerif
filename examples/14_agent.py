"""
Example: NerifAgent with tool calling loop

Demonstrates the ReAct-style agent that can use tools in a loop
...
calculator = Tool(
    ...
    func=lambda expression: str(eval(expression)),  # noqa: S307
)
